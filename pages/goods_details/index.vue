	...
	<view :data-theme="theme">
		...
		<view class="product-con tui-skeleton">
			...
			<view class='footer acea-row row-between-wrapper'>
				...
				<block v-if="type === 'normal'">
					<view @click="setCollect" class='item tui-skeleton-fillet'>
						<view class='iconfont icon-xihuan1  font_color' v-if="userCollect"></view>
			...
			<tui-drawer mode="bottom" :visible="assureDrawer" @close="closeAssure">
				<view class="ensure" >
					<view class="title">{{$t(`page.goodsDetail.assure`)}}<text class="iconfont icon-guanbi5" ></text></view>
					<view class="list">
